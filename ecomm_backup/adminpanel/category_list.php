...
<html lang="en">
			...
			<div class="mainpanel">
				...
				<div class="contentpanel">
					<div class="row">
						...
						<div class="row">
							<button class="btn btn-primary addn">Add Category</button>
						</div>
							...
							<form enctype="multipart/form-data" method="POST">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select id="category_brand_id" name="category_brand_id" data-placeholder="Brand Name" class="form-control width300">
											...
											<span id="category_brand_id_err" class="span_err"></span>
										</div>
									</div><!-- form-group -->
								</div>
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											<input type="text" placeholder="eg: Phone" class="form-control" id="category_name" name="category_name" value="" />
						...
						<?php
							$category_arr = $obj->select("C.*, B.brand_name","category_master AS C INNER JOIN brand_master AS B ON C.category_brand_id = B.brand_id","C.category_status='1' AND B.brand_status='1'");
						?>
							...
							<tbody>
								<?php
									if(is_array($category_arr)){
										...
										<tr>
											<td><?php echo $i; ?></td>
											<td><?php echo $category_val['brand_name']; ?></td>
											<td><?php echo $category_val['category_name']; ?></td>
											<td><a href="#" onclick="javascript:edit_record('<?php echo $category_val['category_id']; ?>','<?php echo $category_val['category_brand_id']; ?>','<?php echo $category_val['category_name']; ?>');" ><i class="fa fa-pencil-square" title="Edit"></i></a> &nbsp; <a href="#" onclick="javascript :delete_record(<?php echo $category_val['category_id']; ?>);"><i class="fa fa-trash-o" title="Delete"></i></a></td>
										</tr>
										<?php
											$i++;
										}
	...
	<script>
		...
		$("#category_save").click(function(){
			...
			if(category_brand_id == '' || isNaN(category_brand_id) || category_brand_id == "0"){
				var message = "Please Select a brand";
				valid('category_brand_id',message);
				return false;
			}
		...
		function edit_record(category_id, category_brand_id, category_name)
		{
			$(".span_err").html("");
			...
			$("#brand_"+category_brand_id).attr("selected","selected");
			return false;
		}
