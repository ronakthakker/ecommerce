		...
		<div class="row">
            ...
            <div class="widget">
					...
					<?php
						...
						<span class="button-checkbox filterbyproducttype"  id="filterproduct<?php echo $cat_val['category_name']?>">
							<button type="button" class="btn checkbox-btn producttype" data-color="primary"><?php echo $cat_val['category_name']?></button>
            ...
            <div class="widget">
					...
					<?php
						...
						if(is_array($get_brands)){
							...
							?>
							<span class="button-checkbox filterbybrand" id="filterbrand<?php echo $brands_val['brand_name']?>">
            ...
            <div class="widget">
					...
					<?php
						...
						if(is_array($get_designs)){
							...
							<span class="button-checkbox filterbydesign">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		?>
		$("#results" ).load( "ajax/pagination.php"+append); //load initial records
		...
		$("#results").on( "click", ".pagination a", function (e){
			...
			var page_no = $(this).attr("data-page"); //get page number from link
			var page = $("#page_val").val(page_no);
			get_products(page)
			
		});
		
		function get_products(page){
			$("#results").load("ajax/pagination.php"+append,{"page":page}, function(){
